...
public class NTAG21X extends NTAG {
    ...
    //
    public void debug() {
//       Log.e("NTAG21X","--------------"+toString()+"---------------");
//       Log.e("NTAG21X","FixedHeader="+fixedHeader);
//       Log.e("NTAG21X","VendorID="+vendorID);
//       Log.e("NTAG21X","ProductType="+productType);
//       Log.e("NTAG21X","ProductSubType="+productSubType);
//       Log.e("NTAG21X","Major="+major);
//       Log.e("NTAG21X","Minor="+minor);
//       Log.e("NTAG21X","StorageSize="+storageSize);
//       Log.e("NTAG21X","ProtocolType="+protocolType);
//       Log.e("NTAG21X","-----------------------------------");
    }
}
