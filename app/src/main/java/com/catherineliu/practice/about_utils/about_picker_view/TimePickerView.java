...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(mPickerOptions.textContentConfirm) ? context.getResources().getString(R.string.btn_sure) : mPickerOptions.textContentConfirm);
            btnCancel.setText(TextUtils.isEmpty(mPickerOptions.textContentCancel) ? context.getResources().getString(R.string.btn_cancel) : mPickerOptions.textContentCancel);
