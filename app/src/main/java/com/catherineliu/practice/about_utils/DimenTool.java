...
//        String path = "./base_common/src/main/res/";
        ...
        try {
            ...
            String sw240file = path + "values-sw240dp-land/dimens.xml";

            String sw480file = path + "values-sw480dp-land/dimens.xml";

            String sw600file = path + "values-sw600dp-land/dimens.xml";

            String sw720file = path + "values-sw720dp-land/dimens.xml";

            String sw800file = path + "values-sw800dp-land/dimens.xml";
